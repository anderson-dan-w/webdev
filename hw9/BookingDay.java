...
//        System.out.println("getDate()");
    ...
    public BookingDay getEndDate(int nDays) {
        BookingDay endDate = new BookingDay(this.getYear(), this.getMonth(),
                this.getDayOfMonth() + nDays);
        if (endDate.badDay() == true) {
            ...
            case 9:
            case 11:
                endDate.setDayOfMonth(endDate.getDayOfMonth() - 31);
                break;
            case 8:
            case 3:
            case 5:
            case 10:
                endDate.setDayOfMonth(endDate.getDayOfMonth() - 30);
                break;
            case 1:
                if ((year % 4) == 0) {
                    endDate.setDayOfMonth(endDate.getDayOfMonth() - 29);
                } else {
                    endDate.setDayOfMonth(endDate.getDayOfMonth() - 28);
                }
                break;
            default:
                break;
